...
- P4-MAT-001 remains open for partial groups inside portfolios, carry-forward/sequence strategies beyond the date bound, reversal-specific matching, mutation/crash-resume and cross-engine properties, and published 10K/100K/1M benchmarks.
