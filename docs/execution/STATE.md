...
- `codex/consolidation-close-lifecycle` is pushed and stacked Draft PR #68 targets `codex/consolidation-translation-core`. It remains unmerged and depends on PR #67.
