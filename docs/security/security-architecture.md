...
| SEC-C-003 Authentication/principal/RBAC | Partial | identity-security | Named-permission and supplied-scope denial plus an exact nine-surface no-self-approval inventory are bounded; universal route/repository ABAC, amount/region/data-class and privileged-access policy, federation, MFA, SCIM, and deployed effectiveness remain open |
...
| SEC-C-009 Object storage/sharing | Partial | evidence-security | Explicit tenant keys, TLS defaults, checksums, retention metadata, and bounded staged JSON/CSV/text/non-redacted client-pack copies with handled-failure rollback; no crash recovery, redaction-completeness, malware/KMS/authorized-delivery pipeline |
...
re-identification/reversibility (R-017), and incomplete hostile-file coverage
(R-018). Enterprise identity (R-007) and hosted
