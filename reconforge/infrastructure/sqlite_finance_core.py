"""SQLite adapter for governed finance-core persistence and policy enforcement."""
...
def _amount_to_minor(value: object, currency_code: str, label: str) -> int:
    try:
        ...
        if "numeric" in msg or "missing" in msg or "finite" in msg or "scientific" in msg:
        ...
        raise PlatformError(f"{label} is invalid: {exc}") from exc
...
class SQLiteFinanceCoreRepository:
