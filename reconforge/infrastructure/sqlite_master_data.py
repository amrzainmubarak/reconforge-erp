"""SQLite master-data repository with governed audit and hierarchy invariants."""
...
from reconforge.application.master_data import MasterDataSummary
...
class SQLiteMasterDataRepository:
    """SQLite adapter enforcing shared master-data invariants and audit events."""
