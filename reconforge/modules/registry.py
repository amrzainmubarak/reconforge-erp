...
_MODULES = (
    ModuleDescriptor(
        ...
        test_evidence=("tests/test_api_foundation.py", "tests/test_db_export_import.py", "tests/test_studio_auth.py"),
    ),
    ModuleDescriptor(
    ...
    ModuleDescriptor(
        ...
        test_evidence=("tests/test_mapping_validation_cli.py", "tests/test_mapping_wizard.py"),
    ),
    ModuleDescriptor(
        ...
        test_evidence=("tests/test_v03_platform.py",),
    ),
    ModuleDescriptor(
