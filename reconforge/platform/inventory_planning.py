"""Governed local inventory counts and deterministic reorder signals."""
...
from reconforge.platform.inventory_planning_repository import (
...
class InventoryPlanningSummary:
    """Bounded counts for one workspace's inventory planning records."""
